...
### GET /bonds
HTML-страница облигаций. Каталог облигаций, рекомендация по риск-профилю,
текущие позиции клиента и форма покупки/продажи. Для человека, не для других блоков.
