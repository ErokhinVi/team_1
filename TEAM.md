...
|---|---|---|---|
| retail | `http://localhost:8001` | `https://raif-offsite-a-retail.onrender.com` | `https://team1-retail.erokhinva.workers.dev` |
| cib | `http://localhost:8002` | `https://raif-offsite-a-cib.onrender.com` | `https://team1-cib.erokhinva.workers.dev` |
| backend | `http://localhost:8003` | `https://raif-offsite-a-backend.onrender.com` | `https://team1-backend.erokhinva.workers.dev` |
