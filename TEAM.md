...
|---|---|---|
| retail | `http://localhost:8001` | `https://raif-offsite-a-retail.onrender.com` |
| cib | `http://localhost:8002` | `https://raif-offsite-a-cib.onrender.com` |
| backend | `http://localhost:8003` | `https://raif-offsite-a-backend.onrender.com` |
